...
export const config = {
  groom: {
    ...
    playlist: 'https://music.youtube.com/playlist?list=PL9fjdW74GSMuUgkypIB6vrfAcFQssdfo2&si=s7DugdSTgF7rf402',
  },
  bride: {
    name: '임찬희',
    father: '아버지 성함',
  ...
  transport: [
    ...
    '주차는 지하 6~7층에 가능하며, 하객분들께는 3시간 무료 주차가 제공됩니다. 1층에서 건물 외부 통유리 엘리베이터로 환승하여 올라오시면 됩니다.',
  ],
